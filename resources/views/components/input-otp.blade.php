    ...
    <div class="flex items-center">
        @for ($x = 1; $x <= $digits; $x++)
            <input
                ...
                @class([
                    'bg-accent-foreground text-accent-content focus:border-accent dark:focus:border-accent flex size-10 items-center justify-center border border-zinc-300 text-center text-sm font-medium transition-colors focus:relative focus:z-10 focus:border-2 focus:outline-none dark:border-zinc-700',
                    'rounded-l-md' => $x === 1,
